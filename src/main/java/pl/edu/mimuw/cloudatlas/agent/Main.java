...
public class Main {
    ...
    private static void createTestHierarchy() throws ParseException, UnknownHostException {
        ...
        ValueContact khaki31Contact = createContact("/uw/khaki31", (byte)192, (byte)168, (byte)0, (byte)80);
        ValueContact whatever01Contact = createContact("/pjwstk/whatever01", (byte)192, (byte)168, (byte)20, (byte)80);
